...
CREATE TABLE IF NOT EXISTS public.tasks (
    ...
    timer_last_stopped_at timestamp with time zone,
    timer_sessions_count integer not null default 0,
    primary key (id)
);
...
ALTER TABLE public.tasks ADD COLUMN IF NOT EXISTS timer_total_ms bigint NOT NULL DEFAULT 0;
ALTER TABLE public.tasks ADD COLUMN IF NOT EXISTS timer_started_at timestamp with time zone;
ALTER TABLE public.tasks ADD COLUMN IF NOT EXISTS timer_last_stopped_at timestamp with time zone;
ALTER TABLE public.tasks ADD COLUMN IF NOT EXISTS timer_sessions_count integer NOT NULL DEFAULT 0;
