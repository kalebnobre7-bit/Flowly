...
let dailyRoutine = safeJSONParse(localStorage.getItem('dailyRoutine'), [
  ...
  {
    text: 'Ler metas e mantra; celular na gaveta',
    completed: false,
    color: 'default',
    isHabit: true
  }
...
export const setDailyRoutine = (routine) => {
  dailyRoutine = routine;
  saveToLocalStorage();
};
export const setWeeklyRecurringTasks = (tasks) => {
  weeklyRecurringTasks = tasks;
  saveToLocalStorage();
};
export const setAllTasksData = (data) => {
  allTasksData = data;
  saveToLocalStorage();
};
export const setHabitsHistory = (history) => {
  habitsHistory = history;
  saveToLocalStorage();
};
export const setRoutineStates = (states) => {
